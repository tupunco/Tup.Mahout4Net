...
namespace Tup.Mahout4Net.Utils
{
    ...
    public class PriorityQueue<TPriority> : ICollection<TPriority>
    {
        private List<TPriority> _baseHeap;
        ...
        public PriorityQueue(int capacity, IComparer<TPriority> comparer)
        {
            ...
            _baseHeap = new List<TPriority>(capacity);
            _comparer = comparer;
        }
        ...
        public PriorityQueue(IEnumerable<TPriority> data)
        ...
        /// <param name="data">data to be inserted into priority queue</param>
        /// <param name="comparer">priority comparer</param>
        public PriorityQueue(IEnumerable<TPriority> data, IComparer<TPriority> comparer)
        {
            if (data == null || comparer == null)
                throw new ArgumentNullException();

            _comparer = comparer;
            _baseHeap = new List<TPriority>(data);
            // heapify data
        ...
        /// </remarks>
        public static PriorityQueue<TPriority> MergeQueues(PriorityQueue<TPriority> pq1, PriorityQueue<TPriority> pq2)
        {
        ...
        /// <returns>resultant priority queue</returns>
        public static PriorityQueue<TPriority> MergeQueues(PriorityQueue<TPriority> pq1, PriorityQueue<TPriority> pq2, IComparer<TPriority> comparer)
        {
            if (pq1 == null || pq2 == null || comparer == null)
                throw new ArgumentNullException();
            // merge data
            PriorityQueue<TPriority> result = new PriorityQueue<TPriority>(pq1.Count + pq2.Count, pq1._comparer);
        ...
        /// <remarks>
        /// </remarks>
        public TPriority Poll()
        {
            if (!IsEmpty)
            {
                TPriority result = _baseHeap[0];
                DeleteRoot();
                return result;
            }
            else
        ...
        {
            TPriority val = _baseHeap[pos1];
            _baseHeap[pos1] = _baseHeap[pos2];
            _baseHeap[pos2] = val;
        }

        private void Insert(TPriority priority)
        {
            _baseHeap.Add(priority);
        ...
        #region ICollection<TPriority> implementation

        /// <summary>
        /// Enqueus element into priority queue
        /// </summary>
        /// <param name="item">element to add</param>
        public void Add(TPriority item)
        {
            Enqueue(item);
        }
        ...
        public bool Contains(TPriority item)
        {
        ...
        /// </remarks>
        public void CopyTo(TPriority[] array, int arrayIndex)
        {
        ...
        public bool Remove(TPriority item)
        {
